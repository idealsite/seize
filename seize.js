...
function showImage(){
  $('.seize').unbind('mouseenter mouseleave click');
  $(this).stop().animate({
    'left': startX-($(this).data('imageBigWidth')/2),
    'top': startY-($(this).data('imageBigHeight')/2),
    'width': $(this).data('imageBigWidth'),
    'height': $(this).data('imageBigHeight'),
    'border-width': 4,
    '-moz-border-radius': 4,
